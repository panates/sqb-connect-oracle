 ...
 * @constructor
 */
function OraMetadata(pool) {
}

const proto = OraMetadata.prototype = {};
proto.constructor = OraMetadata;

/**
 * @return {String}
 * @protected
 */
proto.selectSchemas = function() {
 ...
 * @protected
 */
proto.selectPrimaryKeys = function() {
 ...
 * @protected
 */
proto.selectForeignKeys = function() {
  return 'select ac.owner schema_name, ac.table_name, ac.constraint_name,\n' +
